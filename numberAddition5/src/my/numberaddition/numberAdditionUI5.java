 ...
 * @author Goodluck
 */
public class numberAdditionUI5 extends javax.swing.JFrame {

    /**
     * Creates new form numberAdditionUI
     */
    public numberAdditionUI5() {
        initComponents();
    }
...
//JOptionPane.setBackground(Color.BLUE);
    ...
    private void jCheckBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBox1ActionPerformed
        // TODO add your handling code here:
        try(FileWriter fw = new FileWriter("shopOut1.rtf", true);
...
//            Logger.getLogger(numberAdditionUI5.class.getName()).log(Level.SEVERE, null, ex);
//        }
...
//        PrintWriter myPrinter= new PrintWriter(myWriter);
//        //some code here
//        myPrinter.println(lastNamesVal2);
//        //some code here
//        try {
//            myWriter.close();
//            //myPrinter.close();
...
//        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(numberAdditionUI5.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new numberAdditionUI5().setVisible(true);
            }
        });
    }
